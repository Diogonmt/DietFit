...
namespace DietFit.Views
{
    ...
    /// </summary>
    public sealed partial class HistoricaDados : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.textBlock1.Text = user.getPnome();
            this.textBlock7.Text = user.getHiPeso().ToString();
            this.textBlock2.Text = user.getHiMassaM().ToString();
            this.textBlock3.Text = user.getHiImc().ToString();
            this.textBlock4.Text = user.getHiMassaG().ToString();
            this.textBlock5.Text = user.getHiMetabolismo().ToString();
            this.textBlock6.Text = user.getHiIdadeM().ToString();
        }

        public HistoricaDados()
        {
